  ...
  return (
    <div className="mx-auto max-w-6xl px-4 sm:px-6 py-8">
      ...
      <p className="text-muted mb-8 max-w-2xl">
        A detailed description of how the Evergreen Private Markets Index
      ...
      <div className="flex gap-10">
        ...
        {/* Content */}
        <article className="flex-1 min-w-0 prose-navy">
          ...
          <Section id="universe" title="Universe Construction">
            <p>
          ...
          <Section id="holdings" title="Holdings Extraction">
            <p>
          ...
          <Section id="classification" title="Index Classification">
            <p>
            ...
            <table className="w-full text-sm border-collapse mb-4">
              ...
              <tbody className="text-muted">
                <tr className="border-b border-surface">
                  <td className="py-2 pr-4">Direct Lending</td>
                  <td className="py-2 pr-4">LOAN, DEBT</td>
                  <td className="py-2">CORPORATE</td>
                </tr>
                <tr className="border-b border-surface">
                  <td className="py-2 pr-4">Direct Equity</td>
                ...
                <tr className="border-b border-surface">
                  <td className="py-2 pr-4">Private Credit Fund</td>
                  <td className="py-2 pr-4">FUND (credit keywords)</td>
                  <td className="py-2">FUND</td>
                </tr>
                <tr>
                  <td className="py-2 pr-4">Private Equity Fund</td>
                  <td className="py-2 pr-4">FUND (equity keywords)</td>
                  <td className="py-2">FUND</td>
                </tr>
              </tbody>
            </table>
          ...
          <Section id="matching" title="Position Matching">
            <p>
          ...
          <Section id="returns" title="Return Calculation">
            <p>
          ...
          <Section id="rebalancing" title="Rebalancing & Timing">
            <p>
...
function Section({
  ...
  return (
    <section id={id} className="mb-10 scroll-mt-20">
      <h2 className="text-xl font-semibold text-navy mb-3 pb-2 border-b border-surface-muted">
        {title}
      </h2>
