...
CREATE TABLE pmi_holdings (
    ...
    nport_are_interest_payments_in_arrears TEXT,
    nport_is_paid_in_kind TEXT,
    nport_currency_code TEXT,
    nport_liquidity_classification TEXT,
    entity_id           TEXT,
    canonical_name      TEXT,
...
_HOLDINGS_COLS = [
    ...
    "bdc_investment_identifier", "bdc_form_type",
    ...
    "nport_is_restricted", "nport_quarter",
